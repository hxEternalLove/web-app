...
>vue实例创建=>遍历data中的属性->转化为setter/getter+追踪相关依赖->watcher在组件渲染过程将属性记录为依赖->属性setter被调用时->通知watcher重新计算更新页面。
...
![image.png](https://upload-images.jianshu.io/upload_images/2323089-5bc5bfd58b1a9f44.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
（2）MVVM
...
![image.png](https://upload-images.jianshu.io/upload_images/2323089-d5a16f6b7aedf3f3.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
在Vue中，对响应式处理利用的是Object.defineProperty对数据进行拦截，而这个方法并不能监听到数组内部变化，数组长度变化，数组的截取变化等，所以需要对这些操作进行hack，让Vue能监听到其中的变化。 [图片上传失败...(image-64413b-1646469182749)]
...
**区别：** [图片上传失败...(image-b0a8c-1646469182749)]
...
[图片上传失败...(image-d8ab11-1646469182749)]
